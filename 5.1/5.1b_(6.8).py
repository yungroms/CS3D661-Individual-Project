...
dataset_dir = pathlib.Path(r"C:\Users\rms11\Desktop\Proj\LeafSnap_Leaves_Merged_split_2way\train")
output_dir = pathlib.Path(r"C:\Users\rms11\Desktop\Proj\6.8\Results")
...
# Evaluate model
evaluate_model(resnet_model, test_ds, output_name, output_dir)
