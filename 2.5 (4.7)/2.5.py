...
# Updated model with more layers and nodes
model = tf.keras.Sequential([
    ...
    layers.MaxPooling2D(2, 2),
    layers.Conv2D(512, (3, 3), activation='relu', padding='same'),  # New deeper layer
    layers.MaxPooling2D(2, 2),
    layers.Flatten(),
    layers.Dense(256, activation='relu'),  # Increased nodes in dense layer
    layers.Dropout(0.5),
...
output_directory = R"C:\Users\rms11\Desktop\Proj\4.0_LeafSnap_Merged\Experiment_Results_4.7"
