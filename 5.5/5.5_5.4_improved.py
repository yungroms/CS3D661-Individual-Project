...
naming_base = f"mobilenet_finetune_LR{learning_rate}_BS{batch_size}_E{epochs}"
history = model.fit(
    train_dataset,
    epochs=epochs,
...
output_directory = R"C:\Users\rms11\Desktop\y3_proj\5.7\5.7_results"
...
with open(os.path.join(output_directory, f'{naming_base}_test_results.txt'), 'w') as f:
    f.write(f"Test Loss: {test_loss}\n")
    f.write(f"Test Accuracy: {test_accuracy}\n")

# === SAVE MODEL ===

model.save(os.path.join(output_directory, f"{naming_base}.h5"))
